  ...
  return (
    <div> 
      ...
      <div className="container">
        <div className="grid gap-12">
          ...
          <section 
            ...
            style={{ backgroundImage: "url('https://www.crystaldynamics.com/content/uploads/2023/09/projects-projecthighlights-bg.png')" }}
          >
          ...
          <section 
            ...
            style={{ backgroundImage: "url('https://www.crystaldynamics.com/content/uploads/2023/10/homepage-featuredgames-bg.png')" }}
          >
            {/* Added overlay for better text readability */}
            <div className="absolute inset-0 bg-black/50 z-0"></div>
            {/* Added relative positioning and higher z-index to content */}
              ...
              <div className="container mx-auto px-4 py-8">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-300 mb-4">
                    We are thrilled to announce our new partnership with Innovatech Solutions. This collaboration will...
                  </p>
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-300 mb-4">
                    Tech Inventory is proud to announce that we have been awarded the "Innovation in Tech" award...
                  </p>
                  <Link href="#" className="text-accent hover:text-accent-foreground">
                    Read More
                  </Link>
                ...
                <div>
                  ...
                  <p className="text-gray-300 mb-4">
                    In our latest blog post, we explore the transformative potential of AI in various business sectors...
                  </p>
                  <Link href="#" className="text-accent hover:text-accent-foreground">
                    Read More
                  </Link>
          ...
          >
            ...
            <div className="h-full md:flex md:items-stretch">
              ...
              <div 
                ...
                style={{ backgroundImage: "url('https://www.crystaldynamics.com/content/uploads/2023/08/connectwithus-text-bg.jpg')" }}
              >
      ...
      <footer 
        ...
        style={{ backgroundImage: "url('https://www.crystaldynamics.com/wp-content/themes/unlikely-hero/assets/dist/ob-crystald-footer-bg.jpg')" }}
      >
        <div className="container mx-auto">
          <div className="md:flex md:justify-between md:items-start">
            ...
            <div className="mb-6 md:mb-0">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <Link href="#" className="hover:text-gray-300">News & Community</Link>
            ...
            <div className="mb-6 md:mb-0">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <Link href="#" className="hover:text-gray-300">Privacy Notice</Link>
                <Link href="#" className="hover:text-gray-300">Cookie Notice</Link>
                <Link href="#" className="hover:text-gray-300">Fan Content Policy</Link>
                <Link href="#" className="hover:text-gray-300">Unsolicited Submission Policy</Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-col space-y-2">
                ...
                <Link href="#" className="hover:text-gray-300">Avoiding Job Scams</Link>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 text-center text-gray-400 text-sm">
            © 2025 Tech Inventory. Tech Inve™ is owned and operated by Rohit Saini. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
